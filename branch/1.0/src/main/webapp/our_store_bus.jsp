...
<div id= "title">
	<fmt:message key="our.store.bus" />
</div>
<head>
<meta name="menu" content="Our Store by BUS" />
		...
		<div class="info">
				...
				<div class="right">
					...
					<div class="bottom">
						...
						<img src="<c:url value="/images/google_map_logo.png"/>" width="70"
										height="69" alt="google_map_logo"></img>
					</div>
				</div>
		</div>
